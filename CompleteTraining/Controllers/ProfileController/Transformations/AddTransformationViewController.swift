...
//                let libraryButton = UIBarButtonItem(title: "Library", style: .plain, target: self, action: #selector(openLibrary))
//                picker.navigationItem.rightBarButtonItem = libraryButton
